...
const InternalDashboardSearch = () => {
  ...
  return (
      <div className="Table_Header  w-full flex justify-between border-b-2" style={{ borderColor: theme.borderColor.primary}}>
        ...
        <Input placeholder="Search Directory" name="Search"  leftIcon={<FaSearch />} className="w-full bg-[#f8fafc]" />
        </div>
